...
export default function Login() {
  ...
  return (
    <div className="relative w-full h-screen">
      <img className="absolute w-full h-full -z-20 " src="/icons/loginBg.png" />
      ...
      <div className="flex flex-col items-center justify-center w-full h-full gap-20 xl:flex-row ">
        <div className="flex flex-col items-center justify-center">
          <div className="flex items-center justify-center">
            <img src="icons/whiteLogo.svg" className="w-48 h-48" />
        ...
        <div className="flex w-3/12 bg-white rounded-[20px] h-2/3 justify-center items-center flex-col">
          ...
          <form className="flex flex-col">
            <label className="my-1 font-normal text-dark-gray ">UserName</label>
            <input
              type="text "
            ...
            />
            <label className="my-1 font-normal text-dark-gray ">Password</label>
            <input
              type="password"
              onChange={(e) => {
