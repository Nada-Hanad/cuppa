...
export default function DetailsReclamations() {
  ...
  const fetchReclamations = async () => {
    ...
    const response = await axios
      .get(
        `${DEPLOY_URL}/reclamation/${detailsReclamations}/getReclamation/`,
        config
      )
  ...
  return (
    <div className="flex flex-col items-center pt-4 overflow-x-hidden text-center gap-11">
      ...
      <div className="flex w-[1000px] justify-between">
        ...
        <div
          className={`w-[300px] h-[100px] rounded-[10px] border-[1px] text-white font-bold text-xl flex items-center justify-center ${
            Reclamations.etat_reclamation === "Remboursée"
              ? "bg-green-500"
              : Reclamations.etat_reclamation === "Non-Remboursée"
              ? "bg-red-500"
              : "bg-orange-500"
          }`}
        >
      ...
      <div className="flex w-[1050px] justify-between">
        <div className="w-2/4 h-auto rounded-[10px] bg-white border-[1px] border-[#343A49] text-justify  text-[#343A49] font-bold text-xl flex items-center justify-center">
          ...
          <br />
          <br />
          Prenom : {Reclamations.prenom_consommateur}
          <br />
          Nom : {Reclamations.nom_consommateur}
          <br />
          Numbers de Commande : {Reclamations.numberOfCommande}
          <br />
          Numbers de Reclamations : {Reclamations.numberOfReclamation}
          <br />
        </div>
        <div className="w-2/4 h-auto rounded-[10px] bg-white border-[1px] border-[#343A49] text-justify  text-[#343A49] font-bold text-xl flex items-center justify-center ml-4">
          ...
          <br />
          <br />
          Numero : {Reclamations.id_cmd}
          <br />
          Date : {Reclamations.time_cmd}
          <br />
          Prix : {Reclamations.prix_cmd}
          <br />
          Status: {Reclamations.etat_cmd}
          <br />
        </div>
      </div>

      {Reclamations.etat_reclamation === "Non-traitée" &&
      (Reclamations.type_reclamation === "Commande non reçue" ||
        Reclamations.type_reclamation === "Commande non complete") ? (
        <div className="flex justify-end space-x-5">
          <ValiderReclamation
            idReclamations={Reclamations.id_reclamation}
            fetchReclamations={fetchReclamations}
            data={dataT}
          />
          <NePasvaliderReclamation
            idReclamations={Reclamations.id_reclamation}
            fetchReclamations={fetchReclamations}
            data={dataF}
          />
        ...
        Reclamations.type_reclamation === "Commande insatisfaisante" ? (
        <Send
          idReclamations={Reclamations.id_reclamation}
          fetchReclamations={fetchReclamations}
          data={dataF}
