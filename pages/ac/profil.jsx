  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center md:flex-row gap-x-20 ">
        {isLoading ? (
          <div className="flex h-[500px] w-96  items-center flex-col  justify-center pt-8 px-8 mx-auto mt-8 mb-24 text-center shadow-lg bg-slate-50 sm:w-full md:2/3 lg:w-1/3 min-h-96 ">
            <CircularProgress />
          </div>
        ) : (
