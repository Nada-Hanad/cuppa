...
export default function EditEmployeModal({
	...
	useEffect(() => {
		setFirstName(Advertiser?.profil?.nom_utilisateur);
		setLastName(Advertiser?.profil?.prenom_utilisateur);
		setUsername(Advertiser?.username_utilisateur);
		setSexe(Advertiser?.profil?.sexe_utilisateur);
		setRole(Advertiser?.id_role.toString());
	...
	const handleSave = async () => {
		...
		try {
			const res = await axios.put(
				`${API_URL}/api/account.management/modifyAccount/AM/${Advertiser?.id_utilisateur}`,
				{
					username_utilisateur: username,
					password_utilisateur: password,
					nom_utilisateur: firstName,
					prenom_utilisateur: lastName,
