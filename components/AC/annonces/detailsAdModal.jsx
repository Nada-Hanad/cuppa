...
export default function DetailsADModal({ Ad }) {
  ...
  return (
    <>
      <button
        className="self-center px-2 py-2 bg-dark-grey text-bold  rounded text-white "
        type="button"
            ...
            <div className="relative w-auto max-w-3xl mx-auto my-6">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col  bg-white outline-none focus:outline-none  h-[500px] w-[400px] ">
                ...
                <div className="relative px-12  flex flex-col justify-start   w-full ">
                  <InfoLine title="Nom" value={Ad.nom_annonce} />
                  <InfoLine
                    title="Annonceur"
                    value={Ad.id_annonceur_annonceur.nom_annonceur}
                  />
                  <InfoLine
                    title="durée d'affichage"
                    value={Ad.duree_affichage + " jours"}
                  />
                  <InfoLine
                    title="Nombre des affichage"
                    value={Ad.nombre_affichage}
                  />
                  <InfoLine title="etat" value={Ad.etat_annonce} />
                  <InfoLine title="date de début" value={Ad.date_debut} />
                  <InfoLine title="sexe cible" value={Ad.sexe_cible} />
                </div>
