...
export default function NePasvaliderReclamation({
	idReclamations,
	fetchReclamations,
    data,
	...
	return (
		<>
			<button
				...
				className={'w-[180px] h-[60px] rounded-[15px] border-[3px] border-red-500 text-[#343A49] font-semibold text-[20px] flex items-center justify-center bg-red-500 text-white'}
